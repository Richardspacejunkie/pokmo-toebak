...
---------------|
NEW!
- Adaptive resulution AI
- EXE format!
Changed
- GUI fixes
- Spheal Dark Theme needed (https://www.mediafire.com/file/eorxfhodcj0h2m9/Spheal_Dark_Upd_22_%252B_Negro.zip/file)
---------------|
...
print(f"\n-constructed resource path")

#start tk

root = Tk()
fight_path = resource_path("fight.PNG")
icon_path = resource_path("icon_logo.png")
...
def main():
    ...
    while True:
        ...
        if R == 0 and G == 0 and B == 0:
            print("combat mode")
            if pyautogui.locateOnScreen(fight_path) != None:
                print("attack")
                time.sleep(0.2)
                attack()
        else:
